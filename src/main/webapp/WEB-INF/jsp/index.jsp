...
<head>
    ...
    <link rel="stylesheet" type="text/css"	href="${basePath}static/uikit-2.22.0/css/uikit.gradient.min.css">
    <link rel="stylesheet" type="text/css" href="${basePath}static/uikit-2.22.0/css/components/notify.gradient.min.css">
</head>
<body>
<div
